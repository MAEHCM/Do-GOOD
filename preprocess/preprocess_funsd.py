    ...
    with open(
        ...
        for file in os.listdir(args.data_dir):
            ...
            with open(file_path,"r",encoding="utf8") as f:
                data=json.load(f)
            image_path=file_path.replace("annotations","images").replace("json","tif")
...
def seg_file(file_path,tokenizer,max_len,flag=False):
    ...
    with open(file_path,"r",encoding="utf8"
        ...
        if flag:
            #############################################
            with open("FUNSD/data/test_image_path.txt",'w') as ft:
                for i in range(len(path_list)):
                    ft.write('FUNSD/images/'+path_list[i]+'\n')
...
if __name__=='__main__':
    ...
    #############################
    parser.add_argument("--data_dir",type=str,default="FUNSD/annotations")
