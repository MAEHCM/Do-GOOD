...
class CDIP_dataset(Dataset):
    def __init__(self, root='/mnt/disk2/hjb/for_train'):
...
def train(model,data_loader, data_test_loader, optimizer, epoch, warmup_steps, device, scheduler, config):
    ...
    for i, (image_path,
        ...
        images, images_aug, bboxes = get_image(image_path,bboxes,cdip=True)
...
def main(args, config):
    ...
    datasets = [CDIP_dataset('/mnt/disk2/hjb/for_train')]
    datasets_test = CDIP_dataset('/mnt/disk2/hjb/for_test')
