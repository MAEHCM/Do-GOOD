...
def Process(images, words, boxes, labels):
    ...
    encoded_inputs['image'] = torch.tensor(encoded_inputs['image'])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='/funsd_v2_69.pth')
    ...
    for i in range(1):
        ...
        curr_pred, _, _,_ ,images,words= main(model)
    ...
    with open('/v2_ood/weak_A_map', 'w', encoding='utf-8') as w:
        idx = 0
    ...
    with open('/v2_ood/weak_Q_map', 'w', encoding='utf-8') as w:
    ...
    with open('/v2_ood/strong_question_map', 'w', encoding='utf-8') as w:
        idx = -1
    ...
    with open('/v2_ood/strong_answer_map', 'w', encoding='utf-8') as w:
        idx = -1
        for strong_data in strong_map:
            label = strong_data.split('\t')[-1]
            if label[2:] == 'ANSWER':
    ...
    with open('/v2_ood/weak_other_map', 'w', encoding='utf-8') as w:
        idx = 0
