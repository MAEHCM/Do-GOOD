...
def main(args, config):
    ...
    datasets_test=CDIP_dataset('/mnt/disk2/hjb/sample_cdip_test')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', default='/v2_cdip_47.pth')
    ...
    parser.add_argument("--image_aug", type=str, default=True)
